...
* Action Sheet - [ [template](https://github.com/ionic-team/ionic-conference-app/blob/master/src/pages/match-list/match-list.html) | [code](https://github.com/ionic-team/ionic-conference-app/blob/master/src/pages/match-list/match-list.ts) ]
* Alert - [ [code](https://github.com/ionic-team/ionic-conference-app/blob/master/src/pages/schedule/schedule.ts) ]
* Cards - [ [template](https://github.com/ionic-team/ionic-conference-app/blob/master/src/pages/match-list/match-list.html) ]
...
│    │    │    ├── match-detail.html   * matchDetailPage template
│    │    │    └── match-detail.ts     * matchDetailPage code
│    │    │    └── match-detail.scss   * matchDetailPage stylesheet
│    │    │
│    │    │── match-list/              * matches tab page
│    │    │    ├── match-list.html     * matchListPage template
│    │    │    └── match-list.ts       * matchListPage code
│    │    │    └── match-list.scss     * matchListPage stylesheet
|    |    |
