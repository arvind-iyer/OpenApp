...
var ConferenceData = (function () {
    ...
    ConferenceData.prototype.processData = function (data) {
        ...
        // build up the data by linking matches to sessions
        this.data = data.json();
        this.data.tracks = [];
        ...
        this.data.schedule.forEach(function (day) {
            ...
            day.groups.forEach(function (group) {
                ...
                group.sessions.forEach(function (session) {
                    session.matches = [];
                    if (session.matchNames) {
                        session.matchNames.forEach(function (matchName) {
                            var match = _this.data.matches.find(function (s) { return s.name === matchName; });
                            if (match) {
    ...
    ConferenceData.prototype.getmatches = function () {
        return this.load().map(function (data) {
            return data.matches.sort(function (a, b) {
